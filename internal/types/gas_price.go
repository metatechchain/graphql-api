...
const (
	// GasPricePeriodTypeSuggestion represents the type of gas price period data from the MetaTech node suggestion call.
...
// estimation provided by the MetaTech node.
