...
// Contract represents an MetaTech smart contract at the blockchain.
...
func NewSfcContract(addr *common.Address, ver uint64, block *Block, trx *Transaction) *Contract {
	...
	con.SupportContact = "https://metatechcoin.org"
	con.License = "MIT"
	con.Compiler = "Solidity"
	con.SourceCode = "https://github.com/metatechchain/meta-sfc"
...
func NewStiContract(addr *common.Address, block *Block, trx *Transaction) *Contract {
	...
	con.Version = "1.4.0"
	con.SupportContact = "https://github.com/block42-blockchain-company/metatech-staker-info"
	con.License = "MIT"
	con.Compiler = "Solidity"
	con.SourceCode = "https://github.com/block42-blockchain-company/metatech-staker-info"
