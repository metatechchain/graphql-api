...
// GetMetaTechMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getMetaTechMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCaller) GetMetaTechMint(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DefiFMintAddressProvider.contract.Call(opts, &out, "getMetaTechMint")
...
//
// Solidity: function getMetaTechMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) GetMetaTechMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetMetaTechMint(&_DefiFMintAddressProvider.CallOpts)
}

// GetMetaTechMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getMetaTechMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCallerSession) GetMetaTechMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetMetaTechMint(&_DefiFMintAddressProvider.CallOpts)
}
...
// SetMetaTechMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setMetaTechMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactor) SetMetaTechMint(opts *bind.TransactOpts, _addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.contract.Transact(opts, "setMetaTechMint", _addr)
}

// SetMetaTechMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setMetaTechMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) SetMetaTechMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetMetaTechMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}

// SetMetaTechMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setMetaTechMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactorSession) SetMetaTechMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetMetaTechMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}
