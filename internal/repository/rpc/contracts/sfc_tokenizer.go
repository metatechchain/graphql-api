...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSMTCTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSMTC\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSMTC\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sMTCTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSMTC\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSMTC is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSMTC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSMTC(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSMTC", arg0, arg1)
...
//
// Solidity: function outstandingSMTC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSMTC(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSMTC(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSMTC is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSMTC(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSMTC(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSMTC(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SMTCTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sMTCTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SMTCTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sMTCTokenAddress")
...
//
// Solidity: function sMTCTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SMTCTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SMTCTokenAddress(&_SfcTokenizer.CallOpts)
}

// SMTCTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sMTCTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SMTCTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SMTCTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSMTCTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSMTCTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSMTCTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSMTCTokenAddress", addr)
}

// UpdateSMTCTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSMTCTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSMTCTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSMTCTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSMTCTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSMTCTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSMTCTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSMTCTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSMTC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSMTC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSMTC(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSMTC", toStakerID)
}

// MintSMTC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSMTC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSMTC(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSMTC(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSMTC is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSMTC(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSMTC(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSMTC(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSMTC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSMTC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSMTC(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSMTC", stakerID, amount)
}

// RedeemSMTC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSMTC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSMTC(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSMTC(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSMTC is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSMTC(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSMTC(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSMTC(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
