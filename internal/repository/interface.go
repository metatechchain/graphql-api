...
type Repository interface {
	// Account returns account at MetaTech blockchain for an address, nil if not found.
	Account(*common.Address) (*types.Account, error)

	// AccountBalance returns the current balance of an account at MetaTech blockchain.
	AccountBalance(*common.Address) (*hexutil.Big, error)

	// AccountNonce returns the current number of sent transactions of an account at MetaTech blockchain.
	AccountNonce(*common.Address) (*hexutil.Uint64, error)

	// AccountTransactions returns list of transaction hashes for account at MetaTech blockchain.
	//
	...
	// BlockHeight returns the current height of the MetaTech blockchain in blocks.
	...
	// BlockByNumber returns a block at MetaTech blockchain represented by a number.
	...
	// BlockByHash returns a block at MetaTech blockchain represented by a hash.
	...
	// Contracts returns list of smart contracts at MetaTech blockchain.
	...
	// LoadTransaction returns a transaction at MetaTech blockchain
	// by a hash loaded directly from the node.
	LoadTransaction(hash *common.Hash) (*types.Transaction, error)

	// Transaction returns a transaction at MetaTech blockchain by a hash, nil if not found.
	Transaction(*common.Hash) (*types.Transaction, error)

	// Transactions returns list of transaction hashes at MetaTech blockchain.
	...
	// LastValidatorId returns the last validator id in MetaTech blockchain.
	LastValidatorId() (uint64, error)

	// ValidatorsCount returns the number of stakers in MetaTech blockchain.
	...
	DelegationOutstandingSMTC(*common.Address, *hexutil.Big) (*hexutil.Big, error)
