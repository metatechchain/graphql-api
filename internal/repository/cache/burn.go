...
// MtcBurnTotal returns the current amount of total burned MTC.
func (b *MemBridge) MtcBurnTotal(loader func() (int64, error)) (int64, error) {
...
// MtcBurnUpdate updates in-memory value of the burned MTCs.
func (b *MemBridge) MtcBurnUpdate(burn *types.MtcBurn, loader func() (int64, error)) {
	...
	if burnContainer == nil || (burnContainer != nil && burnContainer.nextLoad <= uint64(burn.BlockNumber)) {
		...
		if err != nil {
			b.log.Criticalf("total burned MTC value not available; %s", err.Error())
			return
		}
	}
...
// MtcBurnUpdate updates in-memory value of the burned MTCs.
func (b *MemBridge) refreshBurnUpdate(burn *types.MtcBurn, loader func() (int64, error)) error {
