...
// getAccount builds the account representation after validating it against Meta node.
...
// AccountTransactions returns slice of AccountTransaction structure for a given account at MetaTech blockchain.
