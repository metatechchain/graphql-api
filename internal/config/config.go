...
// Config defines configuration options structure for MetaTech API server.
type Config struct {
	...
	// Meta represents the node structure
	Meta Meta `mapstructure:"node"`
...
// Meta represents the Meta node access configuration
type Meta struct {
