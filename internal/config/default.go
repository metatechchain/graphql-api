...
const (
	...
	defApplicationName = "MetaTech GraphQL API Server (custom)"
	...
	// defMetaUrl holds default Meta connection string
	defMetaUrl = "~/.metatechchain/data/metatechchain.ipc"
...
var defERC20Logo = map[common.Address]string{
	common.HexToAddress(EmptyAddress): "https://repository.metatechcoin.org/logos/erc20.svg",
}
...
func applyDefaults(cfg *viper.Viper) {
	...
	cfg.SetDefault(keyMetaUrl, defMetaUrl)
