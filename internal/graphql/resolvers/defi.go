...
// defiWMTCSymbol is the symbol used for wrapped MTC tokens.
const defiWMTCSymbol = "WMTC"
...
// DefiNativeToken resolves the native MTC wrapper token.
...
// CanWrapMTC signals if the token can be used to wrap native MTC
// to get some amount of it.
func (dt *DefiToken) CanWrapMTC() bool {
	return dt.Symbol == defiWMTCSymbol
}
