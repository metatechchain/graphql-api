...
type ApiResolver interface {
	...
	// LastStakerId resolves the last staker id in MetaTech blockchain.
	LastStakerId() (hexutil.Uint64, error)

	// StakersNum resolves the number of stakers in MetaTech blockchain.
	...
	// Price resolves price details of the MetaTech blockchain token for the given target symbols.
