...
// weiToMtcDecimals represents decimal conversion between WEI and MTC units.
var weiToMtcDecimals = new(big.Int).SetUint64(1000000000000000000)
...
func (rs *rootResolver) estimateRewardsByAddress(addr *common.Address, ep *types.Epoch, total *hexutil.Big) (EstimatedRewards, error) {
	...
	val := hexutil.Uint64(new(big.Int).Div(balance.ToInt(), weiToMtcDecimals).Uint64())
