...
import (
	"flag"
	"log"
	"metatech-api-graphql/cmd/apiserver/build"
	"metatech-api-graphql/internal/config"
	"metatech-api-graphql/internal/graphql/resolvers"
	"metatech-api-graphql/internal/handlers"
	"metatech-api-graphql/internal/logger"
	"metatech-api-graphql/internal/repository"
	"metatech-api-graphql/internal/svc"
	"net/http"
	"os"
	"os/signal"
	"syscall"
...
func (app *apiServer) run() {
	...
	app.log.Infof("welcome to MetaTech GraphQL API server")
